...
export const wizardCommands = {
  ...
  accountSelect: [
    ...
    cmd('NO_PROBLEM_GO_HOME', 'No Problem Go Home', 'AccountSelect'),
    cmd('NO_PROBLEM_GO_TO_OVERVIEW', 'No Problem Go To Overview', 'AccountSelect'),
    cmd('NO_PROBLEM_GO_TO_CAPTURE', 'No Problem Go To Capture', 'AccountSelect'),
  ...
  checkCapture: [
    ...
    cmd('SPEAK_DETECTED_AMOUNT_OVER_LIMIT', 'Speak Detected Amount Over Limit', 'CheckCapture', 'text'),
    cmd('SPEAK_CHECK_OUT_OF_FRAME', 'Speak Check Out Of Frame', 'CheckCapture'),
    cmd('SPEAK_IMAGE_BLURRED', 'Speak Image Blurred', 'CheckCapture'),
    ...
    cmd('CAPTURE_FRONT_SUCCESS_PROCESSING', 'Front Captured Processing', 'CheckCapture'),
