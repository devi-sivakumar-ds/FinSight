...
export const wizardCommands = {
  ...
  settings: [
    cmd('SET_VERBOSITY_LOW', 'Verbosity Low', 'Settings', 'verbosity'),
    cmd('SET_VERBOSITY_MEDIUM', 'Verbosity Medium', 'Settings', 'verbosity'),
    cmd('SET_VERBOSITY_HIGH', 'Verbosity High', 'Settings', 'verbosity'),
    cmd('SET_PACE_SLOW', 'Pace Slow', 'Settings', 'pace'),
    cmd('SET_PACE_NORMAL', 'Pace Normal', 'Settings', 'pace'),
    cmd('SET_PACE_FAST', 'Pace Fast', 'Settings', 'pace'),
