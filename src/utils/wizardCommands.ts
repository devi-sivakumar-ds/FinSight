...
export const wizardCommands = {
  ...
  settings: [
    ...
    cmd('SETTINGS_CHOOSE_VERBOSITY_LOW', 'Choose Verbosity Low', 'Settings'),
    cmd('SETTINGS_CHOOSE_VERBOSITY_MEDIUM', 'Choose Verbosity Medium', 'Settings'),
    cmd('SETTINGS_CHOOSE_VERBOSITY_HIGH', 'Choose Verbosity High', 'Settings'),
    ...
    cmd('SETTINGS_CHOOSE_PACING_SLOW', 'Choose Pacing Slow', 'Settings'),
    cmd('SETTINGS_CHOOSE_PACING_MEDIUM', 'Choose Pacing Medium', 'Settings'),
    cmd('SETTINGS_CHOOSE_PACING_HIGH', 'Choose Pacing High', 'Settings'),
